...
class jpsps040000:#特定有価証券の内容等の開示に関する内閣府令 第四号様式 有価証券届出書
	CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo4SecuritiesRegistrationStatementHeading = '' #特定有価証券の内容等の開示に関する内閣府令 第四号様式 有価証券届出書 [目次項目]
	...
	NameOfFundRelatedToDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock = '' #届出の対象とした募集（売出）内国投資信託受益証券に係るファンドの名称、表紙 [テキストブロック]
	AmountOfDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock = '' #届出の対象とした募集（売出）内国投資信託受益証券の金額、表紙 [テキストブロック]
	...
	FundNameHeading = '' #ファンドの名称 [目次項目]
	FundNameTextBlock = '' #ファンドの名称 [テキストブロック]
	LegalFormEtcOfDomesticTrustBeneficiaryCertificatesHeading = '' #内国投資信託受益証券の形態等 [目次項目]
	LegalFormEtcOfDomesticTrustBeneficiaryCertificatesTextBlock = '' #内国投資信託受益証券の形態等 [テキストブロック]
	TotalAmountOfIssueOrSecondaryDistributionSecurityInformationHeading = '' #発行（売出）価額の総額、証券情報 [目次項目]
	TotalAmountOfIssueOrSecondaryDistributionSecurityInformationTextBlock = '' #発行（売出）価額の総額、証券情報 [テキストブロック]
	PriceOfIssueOrSecondaryDistributionSecurityInformationHeading = '' #発行（売出）価格、証券情報 [目次項目]
	PriceOfIssueOrSecondaryDistributionSecurityInformationTextBlock = '' #発行（売出）価格、証券情報 [テキストブロック]
	ApplicationFeeSecurityInformationHeading = '' #申込手数料、証券情報 [目次項目]
	ApplicationFeeSecurityInformationTextBlock = '' #申込手数料、証券情報 [テキストブロック]
	ApplicationUnitSecurityInformationHeading = '' #申込単位、証券情報 [目次項目]
	ApplicationUnitSecurityInformationTextBlock = '' #申込単位、証券情報 [テキストブロック]
	ApplicationPeriodSecurityInformationHeading = '' #申込期間、証券情報 [目次項目]
	ApplicationPeriodSecurityInformationTextBlock = '' #申込期間、証券情報 [テキストブロック]
	PlaceForApplicationSecurityInformationHeading = '' #申込取扱場所、証券情報 [目次項目]
	PlaceForApplicationSecurityInformationTextBlock = '' #申込取扱場所、証券情報 [テキストブロック]
	DueDateOfPaymentSecurityInformationHeading = '' #払込期日、証券情報 [目次項目]
	DueDateOfPaymentSecurityInformationTextBlock = '' #払込期日、証券情報 [テキストブロック]
	PlaceForPaymentSecurityInformationHeading = '' #払込取扱場所、証券情報 [目次項目]
	PlaceForPaymentSecurityInformationTextBlock = '' #払込取扱場所、証券情報 [テキストブロック]
	BookEntryTransferInstitutionSecurityInformationHeading = '' #振替機関に関する事項、証券情報 [目次項目]
	BookEntryTransferInstitutionSecurityInformationTextBlock = '' #振替機関に関する事項、証券情報 [テキストブロック]
	OtherInformationSecurityInformationHeading = '' #その他、証券情報 [目次項目]
	OtherInformationSecurityInformationTextBlock = '' #その他、証券情報 [テキストブロック]
	FundInformationHeading = '' #ファンド情報 [目次項目]
	OverviewOfFundHeading = '' #ファンドの状況 [目次項目]
	FeaturesOfFundHeading = '' #ファンドの性格 [目次項目]
	PurposesAndBasicFeaturesOfFundHeading = '' #ファンドの目的及び基本的性格 [目次項目]
	PurposesAndBasicFeaturesOfFundTextBlock = '' #ファンドの目的及び基本的性格 [テキストブロック]
	FundHistoryHeading = '' #ファンドの沿革 [目次項目]
	FundHistoryTextBlock = '' #ファンドの沿革 [テキストブロック]
	FundSchemeHeading = '' #ファンドの仕組み [目次項目]
	FundSchemeTextBlock = '' #ファンドの仕組み [テキストブロック]
	...
	OrganizationAndFrameworkOfInvestmentManagementHeading = '' #運用体制 [目次項目]
	OrganizationAndFrameworkOfInvestmentManagementTextBlock = '' #運用体制 [テキストブロック]
	...
	RedemptionFeeHeading = '' #換金（解約）手数料 [目次項目]
	RedemptionFeeTextBlock = '' #換金（解約）手数料 [テキストブロック]
	ManagementFeesAndChargesHeading = '' #信託報酬等 [目次項目]
	ManagementFeesAndChargesTextBlock = '' #信託報酬等 [テキストブロック]
	...
	SupplementaryReferenceInformationAboutActualPerformanceHeading = '' #（参考情報）運用実績 [目次項目]
	SupplementaryReferenceInformationAboutActualPerformanceTextBlock = '' #（参考情報）運用実績 [テキストブロック]
	AdministrationAndOperationHeading = '' #管理及び運営 [目次項目]
	ProceduresEtcForApplicationAndDistributionHeading = '' #申込（販売）手続等 [目次項目]
	ProceduresEtcForApplicationAndDistributionTextBlock = '' #申込（販売）手続等 [テキストブロック]
	RedemptionProceduresEtcHeading = '' #換金（解約）手続等 [目次項目]
	RedemptionProceduresEtcTextBlock = '' #換金（解約）手続等 [テキストブロック]
	...
	TrustPeriodHeading = '' #信託期間 [目次項目]
	TrustPeriodTextBlock = '' #信託期間 [テキストブロック]
	...
	RightsEtcOfBeneficiariesHeading = '' #受益者の権利等 [目次項目]
	RightsEtcOfBeneficiariesTextBlock = '' #受益者の権利等 [テキストブロック]
	FinancialInformationOfFundHeading = '' #ファンドの経理状況 [目次項目]
	FinancialInformationOfFundTextBlock = '' #ファンドの経理状況 [テキストブロック]
	IntroductoryExplanationAboutFinancialInformationOfFundInvestmentNotYetStartedTextBlock = '' #ファンドの経理状況（運用未開始） [テキストブロック]
	FinancialStatementsHeading = '' #財務諸表 [目次項目]
	BalanceSheetHeading = '' #貸借対照表 [目次項目]
	BalanceSheetTextBlock = '' #貸借対照表 [テキストブロック]
	StatementOfIncomeAndRetainedEarningsHeading = '' #損益及び剰余金計算書 [目次項目]
	StatementOfIncomeAndRetainedEarningsTextBlock = '' #損益及び剰余金計算書 [テキストブロック]
	...
	CurrentStatusOfFundHeading = '' #ファンドの現況 [目次項目]
	CalculationOfNetAssetsHeading = '' #純資産額計算書 [目次項目]
	CalculationOfNetAssetsTextBlock = '' #純資産額計算書 [テキストブロック]
	OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesHeading = '' #内国投資信託受益証券事務の概要 [目次項目]
	OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesTextBlock = '' #内国投資信託受益証券事務の概要 [テキストブロック]
	InformationAboutInvestmentTrustManagementCompanyEtcHeading = '' #委託会社等の情報 [目次項目]
	OverviewOfInvestmentTrustManagementCompanyEtcInformationAboutInvestmentTrustManagementCompanyEtcHeading = '' #委託会社等の概況、委託会社等の情報 [目次項目]
	...
	DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcHeading = '' #事業の内容及び営業の概況、委託会社等の概況 [目次項目]
	DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcTextBlock = '' #事業の内容及び営業の概況、委託会社等の概況 [テキストブロック]
	...
	OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcHeading = '' #その他、委託会社等の情報 [目次項目]
	OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcTextBlock = '' #その他、委託会社等の情報 [テキストブロック]
	IndependentAuditorsReportHeading = '' #独立監査人の報告書 [目次項目]
	IndependentAuditorsReportFundTextBlock = '' #独立監査人の報告書、ファンド [テキストブロック]
	IndependentAuditorsReportFundSemiAnnualPeriodOfNextFiscalYearTextBlock = '' #独立監査人の報告書、ファンド、次の中間期 [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo4SecuritiesRegistrationStatementHeading': #特定有価証券の内容等の開示に関する内閣府令 第四号様式 有価証券届出書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo4SecuritiesRegistrationStatementHeading = fact.value
			...
			elif fact.concept.qname.localName == 'NameOfFundRelatedToDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock': #届出の対象とした募集（売出）内国投資信託受益証券に係るファンドの名称、表紙 [テキストブロック]
				self.NameOfFundRelatedToDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock = fact.value

			elif fact.concept.qname.localName == 'AmountOfDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock': #届出の対象とした募集（売出）内国投資信託受益証券の金額、表紙 [テキストブロック]
				self.AmountOfDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'FundNameHeading': #ファンドの名称 [目次項目]
				self.FundNameHeading = fact.value

			elif fact.concept.qname.localName == 'FundNameTextBlock': #ファンドの名称 [テキストブロック]
				self.FundNameTextBlock = fact.value

			elif fact.concept.qname.localName == 'LegalFormEtcOfDomesticTrustBeneficiaryCertificatesHeading': #内国投資信託受益証券の形態等 [目次項目]
				self.LegalFormEtcOfDomesticTrustBeneficiaryCertificatesHeading = fact.value

			elif fact.concept.qname.localName == 'LegalFormEtcOfDomesticTrustBeneficiaryCertificatesTextBlock': #内国投資信託受益証券の形態等 [テキストブロック]
				self.LegalFormEtcOfDomesticTrustBeneficiaryCertificatesTextBlock = fact.value

			elif fact.concept.qname.localName == 'TotalAmountOfIssueOrSecondaryDistributionSecurityInformationHeading': #発行（売出）価額の総額、証券情報 [目次項目]
				self.TotalAmountOfIssueOrSecondaryDistributionSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'TotalAmountOfIssueOrSecondaryDistributionSecurityInformationTextBlock': #発行（売出）価額の総額、証券情報 [テキストブロック]
				self.TotalAmountOfIssueOrSecondaryDistributionSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'PriceOfIssueOrSecondaryDistributionSecurityInformationHeading': #発行（売出）価格、証券情報 [目次項目]
				self.PriceOfIssueOrSecondaryDistributionSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'PriceOfIssueOrSecondaryDistributionSecurityInformationTextBlock': #発行（売出）価格、証券情報 [テキストブロック]
				self.PriceOfIssueOrSecondaryDistributionSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'ApplicationFeeSecurityInformationHeading': #申込手数料、証券情報 [目次項目]
				self.ApplicationFeeSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'ApplicationFeeSecurityInformationTextBlock': #申込手数料、証券情報 [テキストブロック]
				self.ApplicationFeeSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'ApplicationUnitSecurityInformationHeading': #申込単位、証券情報 [目次項目]
				self.ApplicationUnitSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'ApplicationUnitSecurityInformationTextBlock': #申込単位、証券情報 [テキストブロック]
				self.ApplicationUnitSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'ApplicationPeriodSecurityInformationHeading': #申込期間、証券情報 [目次項目]
				self.ApplicationPeriodSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'ApplicationPeriodSecurityInformationTextBlock': #申込期間、証券情報 [テキストブロック]
				self.ApplicationPeriodSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'PlaceForApplicationSecurityInformationHeading': #申込取扱場所、証券情報 [目次項目]
				self.PlaceForApplicationSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'PlaceForApplicationSecurityInformationTextBlock': #申込取扱場所、証券情報 [テキストブロック]
				self.PlaceForApplicationSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'DueDateOfPaymentSecurityInformationHeading': #払込期日、証券情報 [目次項目]
				self.DueDateOfPaymentSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'DueDateOfPaymentSecurityInformationTextBlock': #払込期日、証券情報 [テキストブロック]
				self.DueDateOfPaymentSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'PlaceForPaymentSecurityInformationHeading': #払込取扱場所、証券情報 [目次項目]
				self.PlaceForPaymentSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'PlaceForPaymentSecurityInformationTextBlock': #払込取扱場所、証券情報 [テキストブロック]
				self.PlaceForPaymentSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'BookEntryTransferInstitutionSecurityInformationHeading': #振替機関に関する事項、証券情報 [目次項目]
				self.BookEntryTransferInstitutionSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'BookEntryTransferInstitutionSecurityInformationTextBlock': #振替機関に関する事項、証券情報 [テキストブロック]
				self.BookEntryTransferInstitutionSecurityInformationTextBlock = fact.value

			elif fact.concept.qname.localName == 'OtherInformationSecurityInformationHeading': #その他、証券情報 [目次項目]
				self.OtherInformationSecurityInformationHeading = fact.value

			elif fact.concept.qname.localName == 'OtherInformationSecurityInformationTextBlock': #その他、証券情報 [テキストブロック]
			...
			elif fact.concept.qname.localName == 'FeaturesOfFundHeading': #ファンドの性格 [目次項目]
				self.FeaturesOfFundHeading = fact.value

			elif fact.concept.qname.localName == 'PurposesAndBasicFeaturesOfFundHeading': #ファンドの目的及び基本的性格 [目次項目]
				self.PurposesAndBasicFeaturesOfFundHeading = fact.value

			elif fact.concept.qname.localName == 'PurposesAndBasicFeaturesOfFundTextBlock': #ファンドの目的及び基本的性格 [テキストブロック]
				self.PurposesAndBasicFeaturesOfFundTextBlock = fact.value

			elif fact.concept.qname.localName == 'FundHistoryHeading': #ファンドの沿革 [目次項目]
				self.FundHistoryHeading = fact.value

			elif fact.concept.qname.localName == 'FundHistoryTextBlock': #ファンドの沿革 [テキストブロック]
				self.FundHistoryTextBlock = fact.value

			elif fact.concept.qname.localName == 'FundSchemeHeading': #ファンドの仕組み [目次項目]
				self.FundSchemeHeading = fact.value

			elif fact.concept.qname.localName == 'FundSchemeTextBlock': #ファンドの仕組み [テキストブロック]
				self.FundSchemeTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'OrganizationAndFrameworkOfInvestmentManagementHeading': #運用体制 [目次項目]
				self.OrganizationAndFrameworkOfInvestmentManagementHeading = fact.value

			elif fact.concept.qname.localName == 'OrganizationAndFrameworkOfInvestmentManagementTextBlock': #運用体制 [テキストブロック]
				self.OrganizationAndFrameworkOfInvestmentManagementTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'RedemptionFeeHeading': #換金（解約）手数料 [目次項目]
				self.RedemptionFeeHeading = fact.value

			elif fact.concept.qname.localName == 'RedemptionFeeTextBlock': #換金（解約）手数料 [テキストブロック]
				self.RedemptionFeeTextBlock = fact.value

			elif fact.concept.qname.localName == 'ManagementFeesAndChargesHeading': #信託報酬等 [目次項目]
				self.ManagementFeesAndChargesHeading = fact.value

			elif fact.concept.qname.localName == 'ManagementFeesAndChargesTextBlock': #信託報酬等 [テキストブロック]
				self.ManagementFeesAndChargesTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'SupplementaryReferenceInformationAboutActualPerformanceHeading': #（参考情報）運用実績 [目次項目]
				self.SupplementaryReferenceInformationAboutActualPerformanceHeading = fact.value

			elif fact.concept.qname.localName == 'SupplementaryReferenceInformationAboutActualPerformanceTextBlock': #（参考情報）運用実績 [テキストブロック]
				self.SupplementaryReferenceInformationAboutActualPerformanceTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'ProceduresEtcForApplicationAndDistributionHeading': #申込（販売）手続等 [目次項目]
				self.ProceduresEtcForApplicationAndDistributionHeading = fact.value

			elif fact.concept.qname.localName == 'ProceduresEtcForApplicationAndDistributionTextBlock': #申込（販売）手続等 [テキストブロック]
				self.ProceduresEtcForApplicationAndDistributionTextBlock = fact.value

			elif fact.concept.qname.localName == 'RedemptionProceduresEtcHeading': #換金（解約）手続等 [目次項目]
				self.RedemptionProceduresEtcHeading = fact.value

			elif fact.concept.qname.localName == 'RedemptionProceduresEtcTextBlock': #換金（解約）手続等 [テキストブロック]
				self.RedemptionProceduresEtcTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'TrustPeriodHeading': #信託期間 [目次項目]
				self.TrustPeriodHeading = fact.value

			elif fact.concept.qname.localName == 'TrustPeriodTextBlock': #信託期間 [テキストブロック]
				self.TrustPeriodTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'RightsEtcOfBeneficiariesHeading': #受益者の権利等 [目次項目]
				self.RightsEtcOfBeneficiariesHeading = fact.value

			elif fact.concept.qname.localName == 'RightsEtcOfBeneficiariesTextBlock': #受益者の権利等 [テキストブロック]
				self.RightsEtcOfBeneficiariesTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'IntroductoryExplanationAboutFinancialInformationOfFundInvestmentNotYetStartedTextBlock': #ファンドの経理状況（運用未開始） [テキストブロック]
				self.IntroductoryExplanationAboutFinancialInformationOfFundInvestmentNotYetStartedTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'StatementOfIncomeAndRetainedEarningsHeading': #損益及び剰余金計算書 [目次項目]
				self.StatementOfIncomeAndRetainedEarningsHeading = fact.value

			elif fact.concept.qname.localName == 'StatementOfIncomeAndRetainedEarningsTextBlock': #損益及び剰余金計算書 [テキストブロック]
				self.StatementOfIncomeAndRetainedEarningsTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'CurrentStatusOfFundHeading': #ファンドの現況 [目次項目]
				self.CurrentStatusOfFundHeading = fact.value
			...
			elif fact.concept.qname.localName == 'OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesHeading': #内国投資信託受益証券事務の概要 [目次項目]
				self.OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesHeading = fact.value

			elif fact.concept.qname.localName == 'OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesTextBlock': #内国投資信託受益証券事務の概要 [テキストブロック]
				self.OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesTextBlock = fact.value

			elif fact.concept.qname.localName == 'InformationAboutInvestmentTrustManagementCompanyEtcHeading': #委託会社等の情報 [目次項目]
				self.InformationAboutInvestmentTrustManagementCompanyEtcHeading = fact.value

			elif fact.concept.qname.localName == 'OverviewOfInvestmentTrustManagementCompanyEtcInformationAboutInvestmentTrustManagementCompanyEtcHeading': #委託会社等の概況、委託会社等の情報 [目次項目]
				self.OverviewOfInvestmentTrustManagementCompanyEtcInformationAboutInvestmentTrustManagementCompanyEtcHeading = fact.value
			...
			elif fact.concept.qname.localName == 'DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcHeading': #事業の内容及び営業の概況、委託会社等の概況 [目次項目]
				self.DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcHeading = fact.value

			elif fact.concept.qname.localName == 'DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcTextBlock': #事業の内容及び営業の概況、委託会社等の概況 [テキストブロック]
				self.DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcHeading': #その他、委託会社等の情報 [目次項目]
				self.OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcHeading = fact.value

			elif fact.concept.qname.localName == 'OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcTextBlock': #その他、委託会社等の情報 [テキストブロック]
				self.OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'IndependentAuditorsReportFundSemiAnnualPeriodOfNextFiscalYearTextBlock': #独立監査人の報告書、ファンド、次の中間期 [テキストブロック]
				self.IndependentAuditorsReportFundSemiAnnualPeriodOfNextFiscalYearTextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo4SecuritiesRegistrationStatementHeading(self): #特定有価証券の内容等の開示に関する内閣府令 第四号様式 有価証券届出書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo4SecuritiesRegistrationStatementHeading
	...
	def getNameOfFundRelatedToDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock(self): #届出の対象とした募集（売出）内国投資信託受益証券に係るファンドの名称、表紙 [テキストブロック]
		return self.NameOfFundRelatedToDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock

	def getAmountOfDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock(self): #届出の対象とした募集（売出）内国投資信託受益証券の金額、表紙 [テキストブロック]
		return self.AmountOfDomesticInvestmentTrustBeneficiaryCertificateToRegisterForOfferingOrDistributionCoverPageTextBlock
	...
	def getFundNameHeading(self): #ファンドの名称 [目次項目]
		return self.FundNameHeading

	def getFundNameTextBlock(self): #ファンドの名称 [テキストブロック]
		return self.FundNameTextBlock

	def getLegalFormEtcOfDomesticTrustBeneficiaryCertificatesHeading(self): #内国投資信託受益証券の形態等 [目次項目]
		return self.LegalFormEtcOfDomesticTrustBeneficiaryCertificatesHeading

	def getLegalFormEtcOfDomesticTrustBeneficiaryCertificatesTextBlock(self): #内国投資信託受益証券の形態等 [テキストブロック]
		return self.LegalFormEtcOfDomesticTrustBeneficiaryCertificatesTextBlock

	def getTotalAmountOfIssueOrSecondaryDistributionSecurityInformationHeading(self): #発行（売出）価額の総額、証券情報 [目次項目]
		return self.TotalAmountOfIssueOrSecondaryDistributionSecurityInformationHeading

	def getTotalAmountOfIssueOrSecondaryDistributionSecurityInformationTextBlock(self): #発行（売出）価額の総額、証券情報 [テキストブロック]
		return self.TotalAmountOfIssueOrSecondaryDistributionSecurityInformationTextBlock

	def getPriceOfIssueOrSecondaryDistributionSecurityInformationHeading(self): #発行（売出）価格、証券情報 [目次項目]
		return self.PriceOfIssueOrSecondaryDistributionSecurityInformationHeading

	def getPriceOfIssueOrSecondaryDistributionSecurityInformationTextBlock(self): #発行（売出）価格、証券情報 [テキストブロック]
		return self.PriceOfIssueOrSecondaryDistributionSecurityInformationTextBlock

	def getApplicationFeeSecurityInformationHeading(self): #申込手数料、証券情報 [目次項目]
		return self.ApplicationFeeSecurityInformationHeading

	def getApplicationFeeSecurityInformationTextBlock(self): #申込手数料、証券情報 [テキストブロック]
		return self.ApplicationFeeSecurityInformationTextBlock

	def getApplicationUnitSecurityInformationHeading(self): #申込単位、証券情報 [目次項目]
		return self.ApplicationUnitSecurityInformationHeading

	def getApplicationUnitSecurityInformationTextBlock(self): #申込単位、証券情報 [テキストブロック]
		return self.ApplicationUnitSecurityInformationTextBlock

	def getApplicationPeriodSecurityInformationHeading(self): #申込期間、証券情報 [目次項目]
		return self.ApplicationPeriodSecurityInformationHeading

	def getApplicationPeriodSecurityInformationTextBlock(self): #申込期間、証券情報 [テキストブロック]
		return self.ApplicationPeriodSecurityInformationTextBlock

	def getPlaceForApplicationSecurityInformationHeading(self): #申込取扱場所、証券情報 [目次項目]
		return self.PlaceForApplicationSecurityInformationHeading

	def getPlaceForApplicationSecurityInformationTextBlock(self): #申込取扱場所、証券情報 [テキストブロック]
		return self.PlaceForApplicationSecurityInformationTextBlock

	def getDueDateOfPaymentSecurityInformationHeading(self): #払込期日、証券情報 [目次項目]
		return self.DueDateOfPaymentSecurityInformationHeading

	def getDueDateOfPaymentSecurityInformationTextBlock(self): #払込期日、証券情報 [テキストブロック]
		return self.DueDateOfPaymentSecurityInformationTextBlock

	def getPlaceForPaymentSecurityInformationHeading(self): #払込取扱場所、証券情報 [目次項目]
		return self.PlaceForPaymentSecurityInformationHeading

	def getPlaceForPaymentSecurityInformationTextBlock(self): #払込取扱場所、証券情報 [テキストブロック]
		return self.PlaceForPaymentSecurityInformationTextBlock

	def getBookEntryTransferInstitutionSecurityInformationHeading(self): #振替機関に関する事項、証券情報 [目次項目]
		return self.BookEntryTransferInstitutionSecurityInformationHeading

	def getBookEntryTransferInstitutionSecurityInformationTextBlock(self): #振替機関に関する事項、証券情報 [テキストブロック]
		return self.BookEntryTransferInstitutionSecurityInformationTextBlock

	def getOtherInformationSecurityInformationHeading(self): #その他、証券情報 [目次項目]
		return self.OtherInformationSecurityInformationHeading

	def getOtherInformationSecurityInformationTextBlock(self): #その他、証券情報 [テキストブロック]
	...
	def getFeaturesOfFundHeading(self): #ファンドの性格 [目次項目]
		return self.FeaturesOfFundHeading

	def getPurposesAndBasicFeaturesOfFundHeading(self): #ファンドの目的及び基本的性格 [目次項目]
		return self.PurposesAndBasicFeaturesOfFundHeading

	def getPurposesAndBasicFeaturesOfFundTextBlock(self): #ファンドの目的及び基本的性格 [テキストブロック]
		return self.PurposesAndBasicFeaturesOfFundTextBlock

	def getFundHistoryHeading(self): #ファンドの沿革 [目次項目]
		return self.FundHistoryHeading

	def getFundHistoryTextBlock(self): #ファンドの沿革 [テキストブロック]
		return self.FundHistoryTextBlock

	def getFundSchemeHeading(self): #ファンドの仕組み [目次項目]
		return self.FundSchemeHeading

	def getFundSchemeTextBlock(self): #ファンドの仕組み [テキストブロック]
		return self.FundSchemeTextBlock
	...
	def getOrganizationAndFrameworkOfInvestmentManagementHeading(self): #運用体制 [目次項目]
		return self.OrganizationAndFrameworkOfInvestmentManagementHeading

	def getOrganizationAndFrameworkOfInvestmentManagementTextBlock(self): #運用体制 [テキストブロック]
		return self.OrganizationAndFrameworkOfInvestmentManagementTextBlock
	...
	def getRedemptionFeeHeading(self): #換金（解約）手数料 [目次項目]
		return self.RedemptionFeeHeading

	def getRedemptionFeeTextBlock(self): #換金（解約）手数料 [テキストブロック]
		return self.RedemptionFeeTextBlock

	def getManagementFeesAndChargesHeading(self): #信託報酬等 [目次項目]
		return self.ManagementFeesAndChargesHeading

	def getManagementFeesAndChargesTextBlock(self): #信託報酬等 [テキストブロック]
		return self.ManagementFeesAndChargesTextBlock
	...
	def getSupplementaryReferenceInformationAboutActualPerformanceHeading(self): #（参考情報）運用実績 [目次項目]
		return self.SupplementaryReferenceInformationAboutActualPerformanceHeading

	def getSupplementaryReferenceInformationAboutActualPerformanceTextBlock(self): #（参考情報）運用実績 [テキストブロック]
		return self.SupplementaryReferenceInformationAboutActualPerformanceTextBlock

	def getAdministrationAndOperationHeading(self): #管理及び運営 [目次項目]
		return self.AdministrationAndOperationHeading

	def getProceduresEtcForApplicationAndDistributionHeading(self): #申込（販売）手続等 [目次項目]
		return self.ProceduresEtcForApplicationAndDistributionHeading

	def getProceduresEtcForApplicationAndDistributionTextBlock(self): #申込（販売）手続等 [テキストブロック]
		return self.ProceduresEtcForApplicationAndDistributionTextBlock

	def getRedemptionProceduresEtcHeading(self): #換金（解約）手続等 [目次項目]
		return self.RedemptionProceduresEtcHeading

	def getRedemptionProceduresEtcTextBlock(self): #換金（解約）手続等 [テキストブロック]
		return self.RedemptionProceduresEtcTextBlock
	...
	def getTrustPeriodHeading(self): #信託期間 [目次項目]
		return self.TrustPeriodHeading

	def getTrustPeriodTextBlock(self): #信託期間 [テキストブロック]
		return self.TrustPeriodTextBlock
	...
	def getRightsEtcOfBeneficiariesHeading(self): #受益者の権利等 [目次項目]
		return self.RightsEtcOfBeneficiariesHeading

	def getRightsEtcOfBeneficiariesTextBlock(self): #受益者の権利等 [テキストブロック]
		return self.RightsEtcOfBeneficiariesTextBlock
	...
	def getIntroductoryExplanationAboutFinancialInformationOfFundInvestmentNotYetStartedTextBlock(self): #ファンドの経理状況（運用未開始） [テキストブロック]
		return self.IntroductoryExplanationAboutFinancialInformationOfFundInvestmentNotYetStartedTextBlock
	...
	def getStatementOfIncomeAndRetainedEarningsHeading(self): #損益及び剰余金計算書 [目次項目]
		return self.StatementOfIncomeAndRetainedEarningsHeading

	def getStatementOfIncomeAndRetainedEarningsTextBlock(self): #損益及び剰余金計算書 [テキストブロック]
		return self.StatementOfIncomeAndRetainedEarningsTextBlock
	...
	def getCurrentStatusOfFundHeading(self): #ファンドの現況 [目次項目]
		return self.CurrentStatusOfFundHeading
	...
	def getOverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesHeading(self): #内国投資信託受益証券事務の概要 [目次項目]
		return self.OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesHeading

	def getOverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesTextBlock(self): #内国投資信託受益証券事務の概要 [テキストブロック]
		return self.OverviewOfOperationalProceduresRelatedToDomesticTrustBeneficiaryCertificatesTextBlock

	def getInformationAboutInvestmentTrustManagementCompanyEtcHeading(self): #委託会社等の情報 [目次項目]
		return self.InformationAboutInvestmentTrustManagementCompanyEtcHeading

	def getOverviewOfInvestmentTrustManagementCompanyEtcInformationAboutInvestmentTrustManagementCompanyEtcHeading(self): #委託会社等の概況、委託会社等の情報 [目次項目]
		return self.OverviewOfInvestmentTrustManagementCompanyEtcInformationAboutInvestmentTrustManagementCompanyEtcHeading
	...
	def getDescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcHeading(self): #事業の内容及び営業の概況、委託会社等の概況 [目次項目]
		return self.DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcHeading

	def getDescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcTextBlock(self): #事業の内容及び営業の概況、委託会社等の概況 [テキストブロック]
		return self.DescriptionOfBusinessAndOverviewOfOperationOverviewOfInvestmentTrustManagementCompanyEtcTextBlock
	...
	def getOtherInformationInformationAboutInvestmentTrustManagementCompanyEtcHeading(self): #その他、委託会社等の情報 [目次項目]
		return self.OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcHeading

	def getOtherInformationInformationAboutInvestmentTrustManagementCompanyEtcTextBlock(self): #その他、委託会社等の情報 [テキストブロック]
		return self.OtherInformationInformationAboutInvestmentTrustManagementCompanyEtcTextBlock
	...
	def getIndependentAuditorsReportFundSemiAnnualPeriodOfNextFiscalYearTextBlock(self): #独立監査人の報告書、ファンド、次の中間期 [テキストブロック]
		return self.IndependentAuditorsReportFundSemiAnnualPeriodOfNextFiscalYearTextBlock
