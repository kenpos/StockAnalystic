...
class jpsps090000:#特定有価証券の内容等の開示に関する内閣府令 第九号様式 有価証券報告書
	CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo9AnnualSecuritiesReportHeading = '' #特定有価証券の内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
			...
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo9AnnualSecuritiesReportHeading': #特定有価証券の内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo9AnnualSecuritiesReportHeading = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo9AnnualSecuritiesReportHeading(self): #特定有価証券の内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo9AnnualSecuritiesReportHeading
