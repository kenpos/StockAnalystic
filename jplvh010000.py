...
class jplvh010000:#株券等の大量保有の状況の開示に関する内閣府令 第一号様式 大量保有報告書
	CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1ReportOfLargeVolumeHoldingHeading = '' #株券等の大量保有の状況の開示に関する内閣府令 第一号様式 大量保有報告書 [目次項目]
	...
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysAbstract = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [タイトル項目]
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysTextBlock = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [テキストブロック]
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysNATextBlock = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（該当なし） [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1ReportOfLargeVolumeHoldingHeading': #株券等の大量保有の状況の開示に関する内閣府令 第一号様式 大量保有報告書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1ReportOfLargeVolumeHoldingHeading = fact.value
			...
			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysAbstract': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [タイトル項目]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysAbstract = fact.value

			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysTextBlock': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [テキストブロック]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysTextBlock = fact.value

			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysNATextBlock': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（該当なし） [テキストブロック]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysNATextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1ReportOfLargeVolumeHoldingHeading(self): #株券等の大量保有の状況の開示に関する内閣府令 第一号様式 大量保有報告書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1ReportOfLargeVolumeHoldingHeading
	...
	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysAbstract(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [タイトル項目]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysAbstract

	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysTextBlock(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況 [テキストブロック]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysTextBlock

	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysNATextBlock(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（該当なし） [テキストブロック]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysNATextBlock
