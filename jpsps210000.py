...
class jpsps210000:#特定有価証券の内容等の開示に関する内閣府令 第二十一号様式 発行登録追補書類
	CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo21ShelfRegistrationSupplementsHeading = '' #特定有価証券の内容等の開示に関する内閣府令 第二十一号様式 発行登録追補書類 [目次項目]
	...
	NameOfInvestmentCorporationRelatedToDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage = '' #発行登録の対象とした募集（売出）内国投資証券に係る投資法人の名称、表紙
	LegalFormOfDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage = '' #発行登録の対象とした募集（売出）内国投資証券の形態、表紙
	...
	OfferingsAndDistributionsInPastCoverPageTextBlock = '' #これまでの募集（売出）実績、表紙 [テキストブロック]
	RemainingAmountCoverPageTextBlock = '' #残額、表紙 [テキストブロック]
	WhenLimitOnOutstandingBalanceWasSpecifiedRemainingAmountCoverPageTextBlock = '' #発行残高の上限を記載した場合、残額、表紙 [テキストブロック]
	RemainingBalanceCoverPage = '' #残高、表紙
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo21ShelfRegistrationSupplementsHeading': #特定有価証券の内容等の開示に関する内閣府令 第二十一号様式 発行登録追補書類 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo21ShelfRegistrationSupplementsHeading = fact.value
			...
			elif fact.concept.qname.localName == 'NameOfInvestmentCorporationRelatedToDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage': #発行登録の対象とした募集（売出）内国投資証券に係る投資法人の名称、表紙
				self.NameOfInvestmentCorporationRelatedToDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage = fact.value

			elif fact.concept.qname.localName == 'LegalFormOfDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage': #発行登録の対象とした募集（売出）内国投資証券の形態、表紙
				self.LegalFormOfDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage = fact.value
			...
			elif fact.concept.qname.localName == 'OfferingsAndDistributionsInPastCoverPageTextBlock': #これまでの募集（売出）実績、表紙 [テキストブロック]
				self.OfferingsAndDistributionsInPastCoverPageTextBlock = fact.value

			elif fact.concept.qname.localName == 'RemainingAmountCoverPageTextBlock': #残額、表紙 [テキストブロック]
				self.RemainingAmountCoverPageTextBlock = fact.value

			elif fact.concept.qname.localName == 'WhenLimitOnOutstandingBalanceWasSpecifiedRemainingAmountCoverPageTextBlock': #発行残高の上限を記載した場合、残額、表紙 [テキストブロック]
				self.WhenLimitOnOutstandingBalanceWasSpecifiedRemainingAmountCoverPageTextBlock = fact.value

			elif fact.concept.qname.localName == 'RemainingBalanceCoverPage': #残高、表紙
				self.RemainingBalanceCoverPage = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo21ShelfRegistrationSupplementsHeading(self): #特定有価証券の内容等の開示に関する内閣府令 第二十一号様式 発行登録追補書類 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo21ShelfRegistrationSupplementsHeading
	...
	def getNameOfInvestmentCorporationRelatedToDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage(self): #発行登録の対象とした募集（売出）内国投資証券に係る投資法人の名称、表紙
		return self.NameOfInvestmentCorporationRelatedToDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage

	def getLegalFormOfDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage(self): #発行登録の対象とした募集（売出）内国投資証券の形態、表紙
		return self.LegalFormOfDomesticInvestmentSecuritiesToShelfRegisterForOfferingOrDistributionCoverPage
	...
	def getOfferingsAndDistributionsInPastCoverPageTextBlock(self): #これまでの募集（売出）実績、表紙 [テキストブロック]
		return self.OfferingsAndDistributionsInPastCoverPageTextBlock

	def getRemainingAmountCoverPageTextBlock(self): #残額、表紙 [テキストブロック]
		return self.RemainingAmountCoverPageTextBlock

	def getWhenLimitOnOutstandingBalanceWasSpecifiedRemainingAmountCoverPageTextBlock(self): #発行残高の上限を記載した場合、残額、表紙 [テキストブロック]
		return self.WhenLimitOnOutstandingBalanceWasSpecifiedRemainingAmountCoverPageTextBlock

	def getRemainingBalanceCoverPage(self): #残高、表紙
		return self.RemainingBalanceCoverPage
