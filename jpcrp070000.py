...
class jpcrp070000:#企業内容等の開示に関する内閣府令 第七号様式 有価証券届出書
	CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo7SecuritiesRegistrationStatementHeading = '' #企業内容等の開示に関する内閣府令 第七号様式 有価証券届出書 [目次項目]
			...
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo7SecuritiesRegistrationStatementHeading': #企業内容等の開示に関する内閣府令 第七号様式 有価証券届出書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo7SecuritiesRegistrationStatementHeading = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo7SecuritiesRegistrationStatementHeading(self): #企業内容等の開示に関する内閣府令 第七号様式 有価証券届出書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo7SecuritiesRegistrationStatementHeading
