...
class jpsps040302:#特定有価証券の内容等の開示に関する内閣府令 第四号の三の二様式 有価証券届出書
	CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo432SecuritiesRegistrationStatementHeading = '' #特定有価証券の内容等の開示に関する内閣府令 第四号の三の二様式 有価証券届出書 [目次項目]
			...
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo432SecuritiesRegistrationStatementHeading': #特定有価証券の内容等の開示に関する内閣府令 第四号の三の二様式 有価証券届出書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo432SecuritiesRegistrationStatementHeading = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo432SecuritiesRegistrationStatementHeading(self): #特定有価証券の内容等の開示に関する内閣府令 第四号の三の二様式 有価証券届出書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo432SecuritiesRegistrationStatementHeading
