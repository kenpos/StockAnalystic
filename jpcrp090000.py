...
class jpcrp090000:#企業内容等の開示に関する内閣府令 第九号様式 有価証券報告書
	CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo9AnnualSecuritiesReportHeading = '' #企業内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
			...
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo9AnnualSecuritiesReportHeading': #企業内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo9AnnualSecuritiesReportHeading = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo9AnnualSecuritiesReportHeading(self): #企業内容等の開示に関する内閣府令 第九号様式 有価証券報告書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo9AnnualSecuritiesReportHeading
