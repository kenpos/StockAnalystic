...
class jpcrp110202:#企業内容等の開示に関する内閣府令 第十一号の二の二様式 発行登録書
	CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo1122ShelfRegistrationStatementHeading = '' #企業内容等の開示に関する内閣府令 第十一号の二の二様式 発行登録書 [目次項目]
	...
	NewIssuanceOfShortTermCorporateBondsHeading = '' #新規発行短期社債 [目次項目]
	NewIssuanceOfShortTermCorporateBondsTextBlock = '' #新規発行短期社債 [テキストブロック]
	ParticularsOfSecondaryDistributionHeading = '' #売出要項 [目次項目]
	ParticularsOfSecondaryDistributionTextBlock = '' #売出要項 [テキストブロック]
	SecondaryDistributionOfShortTermCorporateBondsHeading = '' #売出短期社債 [目次項目]
	SecondaryDistributionOfShortTermCorporateBondsTextBlock = '' #売出短期社債 [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo1122ShelfRegistrationStatementHeading': #企業内容等の開示に関する内閣府令 第十一号の二の二様式 発行登録書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo1122ShelfRegistrationStatementHeading = fact.value
			...
			elif fact.concept.qname.localName == 'NewIssuanceOfShortTermCorporateBondsHeading': #新規発行短期社債 [目次項目]
				self.NewIssuanceOfShortTermCorporateBondsHeading = fact.value

			elif fact.concept.qname.localName == 'NewIssuanceOfShortTermCorporateBondsTextBlock': #新規発行短期社債 [テキストブロック]
				self.NewIssuanceOfShortTermCorporateBondsTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'SecondaryDistributionOfShortTermCorporateBondsHeading': #売出短期社債 [目次項目]
				self.SecondaryDistributionOfShortTermCorporateBondsHeading = fact.value

			elif fact.concept.qname.localName == 'SecondaryDistributionOfShortTermCorporateBondsTextBlock': #売出短期社債 [テキストブロック]
				self.SecondaryDistributionOfShortTermCorporateBondsTextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo1122ShelfRegistrationStatementHeading(self): #企業内容等の開示に関する内閣府令 第十一号の二の二様式 発行登録書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo1122ShelfRegistrationStatementHeading
	...
	def getNewIssuanceOfShortTermCorporateBondsHeading(self): #新規発行短期社債 [目次項目]
		return self.NewIssuanceOfShortTermCorporateBondsHeading

	def getNewIssuanceOfShortTermCorporateBondsTextBlock(self): #新規発行短期社債 [テキストブロック]
		return self.NewIssuanceOfShortTermCorporateBondsTextBlock
	...
	def getSecondaryDistributionOfShortTermCorporateBondsHeading(self): #売出短期社債 [目次項目]
		return self.SecondaryDistributionOfShortTermCorporateBondsHeading

	def getSecondaryDistributionOfShortTermCorporateBondsTextBlock(self): #売出短期社債 [テキストブロック]
		return self.SecondaryDistributionOfShortTermCorporateBondsTextBlock
