...
class jpcrp050000:#企業内容等の開示に関する内閣府令 第五号様式 半期報告書
	CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo5SemiannualSecuritiesReportHeading = '' #企業内容等の開示に関する内閣府令 第五号様式 半期報告書 [目次項目]
	...
	NotesSemiAnnualConsolidatedFinancialStatementsHeading = '' #注記事項、中間連結財務諸表 [目次項目]
	NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsHeading = '' #継続企業の前提に関する事項、中間連結財務諸表 [目次項目]
	NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #継続企業の前提に関する事項、中間連結財務諸表 [テキストブロック]
	NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading = '' #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
	NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #中間連結財務諸表作成のための基本となる重要な事項 [テキストブロック]
	NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading = '' #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
	NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTable = '' #中間連結財務諸表作成のための基本となる重要な事項 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsLineItems = '' #中間連結財務諸表作成のための基本となる重要な事項 [表示項目]
	...
	NotesChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsHeading = '' #会計方針の変更、中間連結財務諸表 [目次項目]
	NotesChangesInAccountingPoliciesInAccordanceWithChangesInAccountingStandardsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #会計基準等の改正等に伴う会計方針の変更、中間連結財務諸表 [テキストブロック]
	NotesVoluntaryChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #会計基準等の改正等以外の正当な理由による会計方針の変更、中間連結財務諸表 [テキストブロック]
	NotesChangesInAccountingPoliciesWhichAreDifficultToDistinguishFromChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #会計上の見積りの変更と区別することが困難な会計方針の変更、中間連結財務諸表 [テキストブロック]
	NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsHeading = '' #表示方法の変更、中間連結財務諸表 [目次項目]
	NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #表示方法の変更、中間連結財務諸表 [テキストブロック]
	NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsHeading = '' #会計上の見積りの変更、中間連結財務諸表 [目次項目]
	NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #会計上の見積りの変更、中間連結財務諸表 [テキストブロック]
	NotesRestatementSemiAnnualConsolidatedFinancialStatementsHeading = '' #修正再表示、中間連結財務諸表 [目次項目]
	NotesRestatementSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #修正再表示、中間連結財務諸表 [テキストブロック]
	NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsHeading = '' #追加情報、中間連結財務諸表 [目次項目]
	NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #追加情報、中間連結財務諸表 [テキストブロック]
	NotesSemiAnnualConsolidatedBalanceSheetHeading = '' #中間連結貸借対照表関係 [目次項目]
	NotesSemiAnnualConsolidatedBalanceSheetHeading = '' #中間連結貸借対照表関係 [目次項目]
	NotesSemiAnnualConsolidatedBalanceSheetTable = '' #中間連結貸借対照表関係 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSemiAnnualConsolidatedBalanceSheetLineItems = '' #中間連結貸借対照表関係 [表示項目]
	...
	NotesSemiAnnualConsolidatedStatementOfIncomeHeading = '' #中間連結損益計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfIncomeHeading = '' #中間連結損益計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfIncomeTable = '' #中間連結損益計算書関係 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSemiAnnualConsolidatedStatementOfIncomeLineItems = '' #中間連結損益計算書関係 [表示項目]
	...
	NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading = '' #中間連結損益及び包括利益計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading = '' #中間連結損益及び包括利益計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementTable = '' #中間連結損益及び包括利益計算書関係 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementLineItems = '' #中間連結損益及び包括利益計算書関係 [表示項目]
	MajorComponentsOfSellingGeneralAndAdministrativeExpensesTextBlock = '' #主要な販売費及び一般管理費 [テキストブロック]
	DepreciationSGA = '' #減価償却費、販売費及び一般管理費
	ProvisionOfAllowanceForDoubtfulAccountsSGA = '' #貸倒引当金繰入額、販売費及び一般管理費
	NotesRegardingImpairmentLossTextBlock = '' #減損損失に関する注記 [テキストブロック]
	...
	DescriptionOfFactThatSimplifiedMethodOfTaxEffectAccountingWasAppliedTextBlock = '' #簡便法による税効果会計を適用している場合の注記 [テキストブロック]
	NotesWhenThereIsSignificantSeasonalFluctuationInSalesOrOperatingExpensesTextBlock = '' #売上高又は営業費用に著しい季節的変動がある場合の注記 [テキストブロック]
	NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading = '' #中間連結株主資本等変動計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading = '' #中間連結株主資本等変動計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfChangesInEquityTable = '' #中間連結株主資本等変動計算書関係 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSemiAnnualConsolidatedStatementOfChangesInEquityLineItems = '' #中間連結株主資本等変動計算書関係 [表示項目]
	...
	NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading = '' #中間連結キャッシュ・フロー計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading = '' #中間連結キャッシュ・フロー計算書関係 [目次項目]
	NotesSemiAnnualConsolidatedStatementOfCashFlowsTable = '' #中間連結キャッシュ・フロー計算書関係 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSemiAnnualConsolidatedStatementOfCashFlowsLineItems = '' #中間連結キャッシュ・フロー計算書関係 [表示項目]
	...
	NotesLeasesSemiAnnualConsolidatedFinancialStatementsHeading = '' #リース取引関係、中間連結財務諸表 [目次項目]
	NotesLeasesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #リース取引関係、中間連結財務諸表 [テキストブロック]
	NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsHeading = '' #金融商品関係、中間連結財務諸表 [目次項目]
	NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #金融商品関係、中間連結財務諸表 [テキストブロック]
	NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading = '' #有価証券関係、中間連結財務諸表 [目次項目]
	NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #有価証券関係、中間連結財務諸表 [テキストブロック]
	NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsHeading = '' #金銭の信託関係、中間連結財務諸表 [目次項目]
	NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #金銭の信託関係、中間連結財務諸表 [テキストブロック]
	NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading = '' #その他有価証券評価差額金、中間連結財務諸表 [目次項目]
	NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #その他有価証券評価差額金、中間連結財務諸表 [テキストブロック]
	NotesDerivativesSemiAnnualConsolidatedFinancialStatementsHeading = '' #デリバティブ取引関係、中間連結財務諸表 [目次項目]
	NotesDerivativesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #デリバティブ取引関係、中間連結財務諸表 [テキストブロック]
	NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsHeading = '' #ストック・オプション等関係、中間連結財務諸表 [目次項目]
	NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #ストック・オプション等関係、中間連結財務諸表 [テキストブロック]
	NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsHeading = '' #企業結合等関係、中間連結財務諸表 [目次項目]
	NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #企業結合等関係、中間連結財務諸表 [テキストブロック]
	NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsHeading = '' #資産除去債務関係、中間連結財務諸表 [目次項目]
	NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #資産除去債務関係、中間連結財務諸表 [テキストブロック]
	NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsHeading = '' #賃貸等不動産関係、中間連結財務諸表 [目次項目]
	NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #賃貸等不動産関係、中間連結財務諸表 [テキストブロック]
	NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsHeading = '' #収益認識関係、中間連結財務諸表 [目次項目]
	NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #収益認識関係、中間連結財務諸表 [テキストブロック]
	NotesInventoriesSemiAnnualConsolidatedFinancialStatementsHeading = '' #棚卸資産関係、中間連結財務諸表 [目次項目]
	NotesInventoriesSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #棚卸資産関係、中間連結財務諸表 [テキストブロック]
	NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading = '' #セグメント情報等、中間連結財務諸表 [目次項目]
	NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #セグメント情報等、中間連結財務諸表 [テキストブロック]
	NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading = '' #セグメント情報等、中間連結財務諸表 [目次項目]
	NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTable = '' #セグメント情報等、中間連結財務諸表 [表]
	ConsolidatedOrNonConsolidatedAxis = '' #連結個別 [軸]
	ConsolidatedMember = '' #連結 [メンバー] ※ディメンションデフォルト
	NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsLineItems = '' #セグメント情報等、中間連結財務諸表 [表示項目]
	...
	NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsHeading = '' #開示対象特別目的会社関係、中間連結財務諸表 [目次項目]
	NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #開示対象特別目的会社関係、中間連結財務諸表 [テキストブロック]
	NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsHeading = '' #１株当たり情報、中間連結財務諸表 [目次項目]
	NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #１株当たり情報、中間連結財務諸表 [テキストブロック]
	NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsHeading = '' #重要な後発事象、中間連結財務諸表 [目次項目]
	NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsTextBlock = '' #重要な後発事象、中間連結財務諸表 [テキストブロック]
	NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPHeading = '' #中間連結財務諸表注記事項（US GAAP） [目次項目]
	NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPTextBlock = '' #中間連結財務諸表注記事項（US GAAP） [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo5SemiannualSecuritiesReportHeading': #企業内容等の開示に関する内閣府令 第五号様式 半期報告書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo5SemiannualSecuritiesReportHeading = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedFinancialStatementsHeading': #注記事項、中間連結財務諸表 [目次項目]
				self.NotesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsHeading': #継続企業の前提に関する事項、中間連結財務諸表 [目次項目]
				self.NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsTextBlock': #継続企業の前提に関する事項、中間連結財務諸表 [テキストブロック]
				self.NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading': #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
				self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTextBlock': #中間連結財務諸表作成のための基本となる重要な事項 [テキストブロック]
				self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading': #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
				self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTable': #中間連結財務諸表作成のための基本となる重要な事項 [表]
				self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsLineItems': #中間連結財務諸表作成のための基本となる重要な事項 [表示項目]
				self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsHeading': #会計方針の変更、中間連結財務諸表 [目次項目]
				self.NotesChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInAccountingPoliciesInAccordanceWithChangesInAccountingStandardsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock': #会計基準等の改正等に伴う会計方針の変更、中間連結財務諸表 [テキストブロック]
				self.NotesChangesInAccountingPoliciesInAccordanceWithChangesInAccountingStandardsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesVoluntaryChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsTextBlock': #会計基準等の改正等以外の正当な理由による会計方針の変更、中間連結財務諸表 [テキストブロック]
				self.NotesVoluntaryChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInAccountingPoliciesWhichAreDifficultToDistinguishFromChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock': #会計上の見積りの変更と区別することが困難な会計方針の変更、中間連結財務諸表 [テキストブロック]
				self.NotesChangesInAccountingPoliciesWhichAreDifficultToDistinguishFromChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsHeading': #表示方法の変更、中間連結財務諸表 [目次項目]
				self.NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsTextBlock': #表示方法の変更、中間連結財務諸表 [テキストブロック]
				self.NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsHeading': #会計上の見積りの変更、中間連結財務諸表 [目次項目]
				self.NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock': #会計上の見積りの変更、中間連結財務諸表 [テキストブロック]
				self.NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesRestatementSemiAnnualConsolidatedFinancialStatementsHeading': #修正再表示、中間連結財務諸表 [目次項目]
				self.NotesRestatementSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesRestatementSemiAnnualConsolidatedFinancialStatementsTextBlock': #修正再表示、中間連結財務諸表 [テキストブロック]
				self.NotesRestatementSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsHeading': #追加情報、中間連結財務諸表 [目次項目]
				self.NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsTextBlock': #追加情報、中間連結財務諸表 [テキストブロック]
				self.NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedBalanceSheetHeading': #中間連結貸借対照表関係 [目次項目]
				self.NotesSemiAnnualConsolidatedBalanceSheetHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedBalanceSheetHeading': #中間連結貸借対照表関係 [目次項目]
				self.NotesSemiAnnualConsolidatedBalanceSheetHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedBalanceSheetTable': #中間連結貸借対照表関係 [表]
				self.NotesSemiAnnualConsolidatedBalanceSheetTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedBalanceSheetLineItems': #中間連結貸借対照表関係 [表示項目]
				self.NotesSemiAnnualConsolidatedBalanceSheetLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfIncomeHeading': #中間連結損益計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfIncomeHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfIncomeHeading': #中間連結損益計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfIncomeHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfIncomeTable': #中間連結損益計算書関係 [表]
				self.NotesSemiAnnualConsolidatedStatementOfIncomeTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfIncomeLineItems': #中間連結損益計算書関係 [表示項目]
				self.NotesSemiAnnualConsolidatedStatementOfIncomeLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading': #中間連結損益及び包括利益計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading': #中間連結損益及び包括利益計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementTable': #中間連結損益及び包括利益計算書関係 [表]
				self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementLineItems': #中間連結損益及び包括利益計算書関係 [表示項目]
				self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading': #中間連結株主資本等変動計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading': #中間連結株主資本等変動計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfChangesInEquityTable': #中間連結株主資本等変動計算書関係 [表]
				self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfChangesInEquityLineItems': #中間連結株主資本等変動計算書関係 [表示項目]
				self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading': #中間連結キャッシュ・フロー計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading': #中間連結キャッシュ・フロー計算書関係 [目次項目]
				self.NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfCashFlowsTable': #中間連結キャッシュ・フロー計算書関係 [表]
				self.NotesSemiAnnualConsolidatedStatementOfCashFlowsTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSemiAnnualConsolidatedStatementOfCashFlowsLineItems': #中間連結キャッシュ・フロー計算書関係 [表示項目]
				self.NotesSemiAnnualConsolidatedStatementOfCashFlowsLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesLeasesSemiAnnualConsolidatedFinancialStatementsHeading': #リース取引関係、中間連結財務諸表 [目次項目]
				self.NotesLeasesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesLeasesSemiAnnualConsolidatedFinancialStatementsTextBlock': #リース取引関係、中間連結財務諸表 [テキストブロック]
				self.NotesLeasesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsHeading': #金融商品関係、中間連結財務諸表 [目次項目]
				self.NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsTextBlock': #金融商品関係、中間連結財務諸表 [テキストブロック]
				self.NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading': #有価証券関係、中間連結財務諸表 [目次項目]
				self.NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock': #有価証券関係、中間連結財務諸表 [テキストブロック]
				self.NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsHeading': #金銭の信託関係、中間連結財務諸表 [目次項目]
				self.NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsTextBlock': #金銭の信託関係、中間連結財務諸表 [テキストブロック]
				self.NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading': #その他有価証券評価差額金、中間連結財務諸表 [目次項目]
				self.NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock': #その他有価証券評価差額金、中間連結財務諸表 [テキストブロック]
				self.NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesDerivativesSemiAnnualConsolidatedFinancialStatementsHeading': #デリバティブ取引関係、中間連結財務諸表 [目次項目]
				self.NotesDerivativesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesDerivativesSemiAnnualConsolidatedFinancialStatementsTextBlock': #デリバティブ取引関係、中間連結財務諸表 [テキストブロック]
				self.NotesDerivativesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsHeading': #ストック・オプション等関係、中間連結財務諸表 [目次項目]
				self.NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock': #ストック・オプション等関係、中間連結財務諸表 [テキストブロック]
				self.NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsHeading': #企業結合等関係、中間連結財務諸表 [目次項目]
				self.NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsTextBlock': #企業結合等関係、中間連結財務諸表 [テキストブロック]
				self.NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsHeading': #資産除去債務関係、中間連結財務諸表 [目次項目]
				self.NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsTextBlock': #資産除去債務関係、中間連結財務諸表 [テキストブロック]
				self.NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsHeading': #賃貸等不動産関係、中間連結財務諸表 [目次項目]
				self.NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsTextBlock': #賃貸等不動産関係、中間連結財務諸表 [テキストブロック]
				self.NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsHeading': #収益認識関係、中間連結財務諸表 [目次項目]
				self.NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsTextBlock': #収益認識関係、中間連結財務諸表 [テキストブロック]
				self.NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesInventoriesSemiAnnualConsolidatedFinancialStatementsHeading': #棚卸資産関係、中間連結財務諸表 [目次項目]
				self.NotesInventoriesSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesInventoriesSemiAnnualConsolidatedFinancialStatementsTextBlock': #棚卸資産関係、中間連結財務諸表 [テキストブロック]
				self.NotesInventoriesSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading': #セグメント情報等、中間連結財務諸表 [目次項目]
				self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTextBlock': #セグメント情報等、中間連結財務諸表 [テキストブロック]
				self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading': #セグメント情報等、中間連結財務諸表 [目次項目]
				self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTable': #セグメント情報等、中間連結財務諸表 [表]
				self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTable = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsLineItems': #セグメント情報等、中間連結財務諸表 [表示項目]
				self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsLineItems = fact.value
			...
			elif fact.concept.qname.localName == 'NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsHeading': #開示対象特別目的会社関係、中間連結財務諸表 [目次項目]
				self.NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsTextBlock': #開示対象特別目的会社関係、中間連結財務諸表 [テキストブロック]
				self.NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsHeading': #１株当たり情報、中間連結財務諸表 [目次項目]
				self.NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsTextBlock': #１株当たり情報、中間連結財務諸表 [テキストブロック]
				self.NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsHeading': #重要な後発事象、中間連結財務諸表 [目次項目]
				self.NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsHeading = fact.value

			elif fact.concept.qname.localName == 'NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsTextBlock': #重要な後発事象、中間連結財務諸表 [テキストブロック]
				self.NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPHeading': #中間連結財務諸表注記事項（US GAAP） [目次項目]
				self.NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPHeading = fact.value

			elif fact.concept.qname.localName == 'NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPTextBlock': #中間連結財務諸表注記事項（US GAAP） [テキストブロック]
				self.NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPTextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo5SemiannualSecuritiesReportHeading(self): #企業内容等の開示に関する内閣府令 第五号様式 半期報告書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo5SemiannualSecuritiesReportHeading
	...
	def getNotesSemiAnnualConsolidatedFinancialStatementsHeading(self): #注記事項、中間連結財務諸表 [目次項目]
		return self.NotesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsHeading(self): #継続企業の前提に関する事項、中間連結財務諸表 [目次項目]
		return self.NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #継続企業の前提に関する事項、中間連結財務諸表 [テキストブロック]
		return self.NotesUncertaintiesOfEntitysAbilityToContinueAsGoingConcernSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading(self): #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
		return self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #中間連結財務諸表作成のための基本となる重要な事項 [テキストブロック]
		return self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading(self): #中間連結財務諸表作成のための基本となる重要な事項 [目次項目]
		return self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTable(self): #中間連結財務諸表作成のための基本となる重要な事項 [表]
		return self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsTable
	...
	def getNotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsLineItems(self): #中間連結財務諸表作成のための基本となる重要な事項 [表示項目]
		return self.NotesSignificantAccountingPoliciesForPreparationOfSemiAnnualConsolidatedFinancialStatementsLineItems
	...
	def getNotesChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsHeading(self): #会計方針の変更、中間連結財務諸表 [目次項目]
		return self.NotesChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesChangesInAccountingPoliciesInAccordanceWithChangesInAccountingStandardsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #会計基準等の改正等に伴う会計方針の変更、中間連結財務諸表 [テキストブロック]
		return self.NotesChangesInAccountingPoliciesInAccordanceWithChangesInAccountingStandardsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesVoluntaryChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #会計基準等の改正等以外の正当な理由による会計方針の変更、中間連結財務諸表 [テキストブロック]
		return self.NotesVoluntaryChangesInAccountingPoliciesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesChangesInAccountingPoliciesWhichAreDifficultToDistinguishFromChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #会計上の見積りの変更と区別することが困難な会計方針の変更、中間連結財務諸表 [テキストブロック]
		return self.NotesChangesInAccountingPoliciesWhichAreDifficultToDistinguishFromChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsHeading(self): #表示方法の変更、中間連結財務諸表 [目次項目]
		return self.NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #表示方法の変更、中間連結財務諸表 [テキストブロック]
		return self.NotesChangesInPresentationSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsHeading(self): #会計上の見積りの変更、中間連結財務諸表 [目次項目]
		return self.NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #会計上の見積りの変更、中間連結財務諸表 [テキストブロック]
		return self.NotesChangesInAccountingEstimatesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesRestatementSemiAnnualConsolidatedFinancialStatementsHeading(self): #修正再表示、中間連結財務諸表 [目次項目]
		return self.NotesRestatementSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesRestatementSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #修正再表示、中間連結財務諸表 [テキストブロック]
		return self.NotesRestatementSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsHeading(self): #追加情報、中間連結財務諸表 [目次項目]
		return self.NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #追加情報、中間連結財務諸表 [テキストブロック]
		return self.NotesAdditionalInformationSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSemiAnnualConsolidatedBalanceSheetHeading(self): #中間連結貸借対照表関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedBalanceSheetHeading

	def getNotesSemiAnnualConsolidatedBalanceSheetHeading(self): #中間連結貸借対照表関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedBalanceSheetHeading

	def getNotesSemiAnnualConsolidatedBalanceSheetTable(self): #中間連結貸借対照表関係 [表]
		return self.NotesSemiAnnualConsolidatedBalanceSheetTable
	...
	def getNotesSemiAnnualConsolidatedBalanceSheetLineItems(self): #中間連結貸借対照表関係 [表示項目]
		return self.NotesSemiAnnualConsolidatedBalanceSheetLineItems
	...
	def getNotesSemiAnnualConsolidatedStatementOfIncomeHeading(self): #中間連結損益計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfIncomeHeading

	def getNotesSemiAnnualConsolidatedStatementOfIncomeHeading(self): #中間連結損益計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfIncomeHeading

	def getNotesSemiAnnualConsolidatedStatementOfIncomeTable(self): #中間連結損益計算書関係 [表]
		return self.NotesSemiAnnualConsolidatedStatementOfIncomeTable
	...
	def getNotesSemiAnnualConsolidatedStatementOfIncomeLineItems(self): #中間連結損益計算書関係 [表示項目]
		return self.NotesSemiAnnualConsolidatedStatementOfIncomeLineItems
	...
	def getNotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading(self): #中間連結損益及び包括利益計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading

	def getNotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading(self): #中間連結損益及び包括利益計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementHeading

	def getNotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementTable(self): #中間連結損益及び包括利益計算書関係 [表]
		return self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementTable
	...
	def getNotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementLineItems(self): #中間連結損益及び包括利益計算書関係 [表示項目]
		return self.NotesSemiAnnualConsolidatedStatementOfComprehensiveIncomeSingleStatementLineItems
	...
	def getNotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading(self): #中間連結株主資本等変動計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading

	def getNotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading(self): #中間連結株主資本等変動計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityHeading

	def getNotesSemiAnnualConsolidatedStatementOfChangesInEquityTable(self): #中間連結株主資本等変動計算書関係 [表]
		return self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityTable
	...
	def getNotesSemiAnnualConsolidatedStatementOfChangesInEquityLineItems(self): #中間連結株主資本等変動計算書関係 [表示項目]
		return self.NotesSemiAnnualConsolidatedStatementOfChangesInEquityLineItems
	...
	def getNotesSemiAnnualConsolidatedStatementOfCashFlowsHeading(self): #中間連結キャッシュ・フロー計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading

	def getNotesSemiAnnualConsolidatedStatementOfCashFlowsHeading(self): #中間連結キャッシュ・フロー計算書関係 [目次項目]
		return self.NotesSemiAnnualConsolidatedStatementOfCashFlowsHeading

	def getNotesSemiAnnualConsolidatedStatementOfCashFlowsTable(self): #中間連結キャッシュ・フロー計算書関係 [表]
		return self.NotesSemiAnnualConsolidatedStatementOfCashFlowsTable
	...
	def getNotesSemiAnnualConsolidatedStatementOfCashFlowsLineItems(self): #中間連結キャッシュ・フロー計算書関係 [表示項目]
		return self.NotesSemiAnnualConsolidatedStatementOfCashFlowsLineItems
	...
	def getNotesLeasesSemiAnnualConsolidatedFinancialStatementsHeading(self): #リース取引関係、中間連結財務諸表 [目次項目]
		return self.NotesLeasesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesLeasesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #リース取引関係、中間連結財務諸表 [テキストブロック]
		return self.NotesLeasesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsHeading(self): #金融商品関係、中間連結財務諸表 [目次項目]
		return self.NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #金融商品関係、中間連結財務諸表 [テキストブロック]
		return self.NotesFinancialInstrumentsSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading(self): #有価証券関係、中間連結財務諸表 [目次項目]
		return self.NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #有価証券関係、中間連結財務諸表 [テキストブロック]
		return self.NotesSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsHeading(self): #金銭の信託関係、中間連結財務諸表 [目次項目]
		return self.NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #金銭の信託関係、中間連結財務諸表 [テキストブロック]
		return self.NotesMoneyHeldInTrustSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading(self): #その他有価証券評価差額金、中間連結財務諸表 [目次項目]
		return self.NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #その他有価証券評価差額金、中間連結財務諸表 [テキストブロック]
		return self.NotesValuationDifferenceOnAvailableForSaleSecuritiesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesDerivativesSemiAnnualConsolidatedFinancialStatementsHeading(self): #デリバティブ取引関係、中間連結財務諸表 [目次項目]
		return self.NotesDerivativesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesDerivativesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #デリバティブ取引関係、中間連結財務諸表 [テキストブロック]
		return self.NotesDerivativesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsHeading(self): #ストック・オプション等関係、中間連結財務諸表 [目次項目]
		return self.NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #ストック・オプション等関係、中間連結財務諸表 [テキストブロック]
		return self.NotesShareOptionsEtcSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsHeading(self): #企業結合等関係、中間連結財務諸表 [目次項目]
		return self.NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #企業結合等関係、中間連結財務諸表 [テキストブロック]
		return self.NotesBusinessCombinationsSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsHeading(self): #資産除去債務関係、中間連結財務諸表 [目次項目]
		return self.NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #資産除去債務関係、中間連結財務諸表 [テキストブロック]
		return self.NotesAssetRetirementObligationsSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsHeading(self): #賃貸等不動産関係、中間連結財務諸表 [目次項目]
		return self.NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #賃貸等不動産関係、中間連結財務諸表 [テキストブロック]
		return self.NotesRealEstateForLeaseEtcSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsHeading(self): #収益認識関係、中間連結財務諸表 [目次項目]
		return self.NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #収益認識関係、中間連結財務諸表 [テキストブロック]
		return self.NotesRevenueRecognitionSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesInventoriesSemiAnnualConsolidatedFinancialStatementsHeading(self): #棚卸資産関係、中間連結財務諸表 [目次項目]
		return self.NotesInventoriesSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesInventoriesSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #棚卸資産関係、中間連結財務諸表 [テキストブロック]
		return self.NotesInventoriesSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading(self): #セグメント情報等、中間連結財務諸表 [目次項目]
		return self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #セグメント情報等、中間連結財務諸表 [テキストブロック]
		return self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading(self): #セグメント情報等、中間連結財務諸表 [目次項目]
		return self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTable(self): #セグメント情報等、中間連結財務諸表 [表]
		return self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsTable
	...
	def getNotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsLineItems(self): #セグメント情報等、中間連結財務諸表 [表示項目]
		return self.NotesSegmentInformationEtcSemiAnnualConsolidatedFinancialStatementsLineItems
	...
	def getNotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsHeading(self): #開示対象特別目的会社関係、中間連結財務諸表 [目次項目]
		return self.NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #開示対象特別目的会社関係、中間連結財務諸表 [テキストブロック]
		return self.NotesSpecialPurposeEntitiesSubjectToDisclosureSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsHeading(self): #１株当たり情報、中間連結財務諸表 [目次項目]
		return self.NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #１株当たり情報、中間連結財務諸表 [テキストブロック]
		return self.NotesPerShareInformationSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsHeading(self): #重要な後発事象、中間連結財務諸表 [目次項目]
		return self.NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsHeading

	def getNotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsTextBlock(self): #重要な後発事象、中間連結財務諸表 [テキストブロック]
		return self.NotesSignificantEventsAfterReportingPeriodSemiAnnualConsolidatedFinancialStatementsTextBlock

	def getNotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPHeading(self): #中間連結財務諸表注記事項（US GAAP） [目次項目]
		return self.NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPHeading

	def getNotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPTextBlock(self): #中間連結財務諸表注記事項（US GAAP） [テキストブロック]
		return self.NotesToSemiAnnualConsolidatedFinancialStatementsUSGAAPTextBlock
