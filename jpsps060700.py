...
class jpsps060700:#特定有価証券の内容等の開示に関する内閣府令 第六号の七及び第七号様式 有価証券報告書【みなし有価証券届出書】
	CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo67AndNo7AnnualSecuritiesReportAlsoDeemedAsSecuritiesRegistrationStatementHeading = '' #特定有価証券の内容等の開示に関する内閣府令 第六号の七及び第七号様式 有価証券報告書【みなし有価証券届出書】 [目次項目]
	CoverPageHeading = '' #表紙 [目次項目]
	CoverPageHeading = '' #表紙 [目次項目]
	DocumentTitleParticularsOfPublicOfferingEtcCoverPage = '' #提出書類、募集事項等記載書面、表紙
	DocumentTitleAnnualSecuritiesReportCoverPage = '' #提出書類、有価証券報告書、表紙
	...
	AnnualSecuritiesReportHeading = '' #有価証券報告書 [目次項目]
	...
	SupplementaryReferenceInformationHeading = '' #参考情報 [目次項目]
	SupplementaryReferenceInformationTextBlock = '' #参考情報 [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo67AndNo7AnnualSecuritiesReportAlsoDeemedAsSecuritiesRegistrationStatementHeading': #特定有価証券の内容等の開示に関する内閣府令 第六号の七及び第七号様式 有価証券報告書【みなし有価証券届出書】 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo67AndNo7AnnualSecuritiesReportAlsoDeemedAsSecuritiesRegistrationStatementHeading = fact.value
			...
			elif fact.concept.qname.localName == 'DocumentTitleParticularsOfPublicOfferingEtcCoverPage': #提出書類、募集事項等記載書面、表紙
				self.DocumentTitleParticularsOfPublicOfferingEtcCoverPage = fact.value

			elif fact.concept.qname.localName == 'DocumentTitleAnnualSecuritiesReportCoverPage': #提出書類、有価証券報告書、表紙
				self.DocumentTitleAnnualSecuritiesReportCoverPage = fact.value
			...
			elif fact.concept.qname.localName == 'AnnualSecuritiesReportHeading': #有価証券報告書 [目次項目]
				self.AnnualSecuritiesReportHeading = fact.value
			...
			elif fact.concept.qname.localName == 'SupplementaryReferenceInformationHeading': #参考情報 [目次項目]
				self.SupplementaryReferenceInformationHeading = fact.value

			elif fact.concept.qname.localName == 'SupplementaryReferenceInformationTextBlock': #参考情報 [テキストブロック]
				self.SupplementaryReferenceInformationTextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo67AndNo7AnnualSecuritiesReportAlsoDeemedAsSecuritiesRegistrationStatementHeading(self): #特定有価証券の内容等の開示に関する内閣府令 第六号の七及び第七号様式 有価証券報告書【みなし有価証券届出書】 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfInformationEtcOnSpecifiedSecuritiesFormNo67AndNo7AnnualSecuritiesReportAlsoDeemedAsSecuritiesRegistrationStatementHeading
	...
	def getDocumentTitleParticularsOfPublicOfferingEtcCoverPage(self): #提出書類、募集事項等記載書面、表紙
		return self.DocumentTitleParticularsOfPublicOfferingEtcCoverPage

	def getDocumentTitleAnnualSecuritiesReportCoverPage(self): #提出書類、有価証券報告書、表紙
		return self.DocumentTitleAnnualSecuritiesReportCoverPage
	...
	def getAnnualSecuritiesReportHeading(self): #有価証券報告書 [目次項目]
		return self.AnnualSecuritiesReportHeading
	...
	def getSupplementaryReferenceInformationHeading(self): #参考情報 [目次項目]
		return self.SupplementaryReferenceInformationHeading

	def getSupplementaryReferenceInformationTextBlock(self): #参考情報 [テキストブロック]
		return self.SupplementaryReferenceInformationTextBlock
