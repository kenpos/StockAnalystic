...
class jplvh020000:#株券等の大量保有の状況の開示に関する内閣府令 第一号及び第二号様式 大量保有報告書
	CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1AndNo2ReportOfLargeVolumeHoldingHeading = '' #株券等の大量保有の状況の開示に関する内閣府令 第一号及び第二号様式 大量保有報告書 [目次項目]
	...
	ActOfMakingImportantProposalEtcAbstract = '' #重要提案行為等 [タイトル項目]
	ActOfMakingImportantProposalEtc = '' #重要提案行為等
	ActOfMakingImportantProposalEtcNA = '' #重要提案行為等（該当なし）
	...
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferAbstract = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [タイトル項目]
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferTextBlock = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [テキストブロック]
	DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferNATextBlock = '' #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合）（該当なし） [テキストブロック]
	...
	FundingForAcquisitionOfStocksEtcHeldAbstract = '' #保有株券等の取得資金 [タイトル項目]
	BreakdownOfFundingAbstract = '' #取得資金の内訳 [タイトル項目]
	AmountOfOwnFund = '' #自己資金額
	TotalAmountOfBorrowings = '' #借入金額計
	TotalAmountFromOtherSources = '' #その他金額計
	BreakdownOfTotalAmountFromOtherSources = '' #上記（その他金額計）の内訳
	TotalAmountOfFundingForAcquisition = '' #取得資金合計
	NotesFundingForAcquisitionOfStocksEtcHeldTextBlock = '' #欄外注記、取得資金の内訳 [テキストブロック]
	BreakdownOfBorrowingsAbstract = '' #借入金の内訳 [タイトル項目]
	BreakdownOfBorrowingsTextBlock = '' #借入金の内訳 [テキストブロック]
	BreakdownOfBorrowingsNATextBlock = '' #借入金の内訳（該当なし） [テキストブロック]
	NamesEtcOfCreditorsAbstract = '' #借入先の名称等 [タイトル項目]
	NamesEtcOfCreditorsTextBlock = '' #借入先の名称等 [テキストブロック]
	NamesEtcOfCreditorsNATextBlock = '' #借入先の名称等（該当なし） [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1AndNo2ReportOfLargeVolumeHoldingHeading': #株券等の大量保有の状況の開示に関する内閣府令 第一号及び第二号様式 大量保有報告書 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1AndNo2ReportOfLargeVolumeHoldingHeading = fact.value
			...
			elif fact.concept.qname.localName == 'ActOfMakingImportantProposalEtcAbstract': #重要提案行為等 [タイトル項目]
				self.ActOfMakingImportantProposalEtcAbstract = fact.value

			elif fact.concept.qname.localName == 'ActOfMakingImportantProposalEtc': #重要提案行為等
				self.ActOfMakingImportantProposalEtc = fact.value

			elif fact.concept.qname.localName == 'ActOfMakingImportantProposalEtcNA': #重要提案行為等（該当なし）
				self.ActOfMakingImportantProposalEtcNA = fact.value
			...
			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferAbstract': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [タイトル項目]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferAbstract = fact.value

			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferTextBlock': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [テキストブロック]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferTextBlock = fact.value

			elif fact.concept.qname.localName == 'DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferNATextBlock': #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合）（該当なし） [テキストブロック]
				self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferNATextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'FundingForAcquisitionOfStocksEtcHeldAbstract': #保有株券等の取得資金 [タイトル項目]
				self.FundingForAcquisitionOfStocksEtcHeldAbstract = fact.value

			elif fact.concept.qname.localName == 'BreakdownOfFundingAbstract': #取得資金の内訳 [タイトル項目]
				self.BreakdownOfFundingAbstract = fact.value

			elif fact.concept.qname.localName == 'AmountOfOwnFund': #自己資金額
				self.AmountOfOwnFund = fact.value

			elif fact.concept.qname.localName == 'TotalAmountOfBorrowings': #借入金額計
				self.TotalAmountOfBorrowings = fact.value

			elif fact.concept.qname.localName == 'TotalAmountFromOtherSources': #その他金額計
				self.TotalAmountFromOtherSources = fact.value

			elif fact.concept.qname.localName == 'BreakdownOfTotalAmountFromOtherSources': #上記（その他金額計）の内訳
				self.BreakdownOfTotalAmountFromOtherSources = fact.value

			elif fact.concept.qname.localName == 'TotalAmountOfFundingForAcquisition': #取得資金合計
				self.TotalAmountOfFundingForAcquisition = fact.value

			elif fact.concept.qname.localName == 'NotesFundingForAcquisitionOfStocksEtcHeldTextBlock': #欄外注記、取得資金の内訳 [テキストブロック]
				self.NotesFundingForAcquisitionOfStocksEtcHeldTextBlock = fact.value

			elif fact.concept.qname.localName == 'BreakdownOfBorrowingsAbstract': #借入金の内訳 [タイトル項目]
				self.BreakdownOfBorrowingsAbstract = fact.value

			elif fact.concept.qname.localName == 'BreakdownOfBorrowingsTextBlock': #借入金の内訳 [テキストブロック]
				self.BreakdownOfBorrowingsTextBlock = fact.value

			elif fact.concept.qname.localName == 'BreakdownOfBorrowingsNATextBlock': #借入金の内訳（該当なし） [テキストブロック]
				self.BreakdownOfBorrowingsNATextBlock = fact.value

			elif fact.concept.qname.localName == 'NamesEtcOfCreditorsAbstract': #借入先の名称等 [タイトル項目]
				self.NamesEtcOfCreditorsAbstract = fact.value

			elif fact.concept.qname.localName == 'NamesEtcOfCreditorsTextBlock': #借入先の名称等 [テキストブロック]
				self.NamesEtcOfCreditorsTextBlock = fact.value

			elif fact.concept.qname.localName == 'NamesEtcOfCreditorsNATextBlock': #借入先の名称等（該当なし） [テキストブロック]
				self.NamesEtcOfCreditorsNATextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1AndNo2ReportOfLargeVolumeHoldingHeading(self): #株券等の大量保有の状況の開示に関する内閣府令 第一号及び第二号様式 大量保有報告書 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfStatusOfLargeVolumeHoldingOfShareCertificatesEtcFormNo1AndNo2ReportOfLargeVolumeHoldingHeading
	...
	def getActOfMakingImportantProposalEtcAbstract(self): #重要提案行為等 [タイトル項目]
		return self.ActOfMakingImportantProposalEtcAbstract

	def getActOfMakingImportantProposalEtc(self): #重要提案行為等
		return self.ActOfMakingImportantProposalEtc

	def getActOfMakingImportantProposalEtcNA(self): #重要提案行為等（該当なし）
		return self.ActOfMakingImportantProposalEtcNA
	...
	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferAbstract(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [タイトル項目]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferAbstract

	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferTextBlock(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合） [テキストブロック]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferTextBlock

	def getDetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferNATextBlock(self): #当該株券等の発行者の発行する株券等に関する最近60日間の取得又は処分の状況（短期大量譲渡に該当する場合）（該当なし） [テキストブロック]
		return self.DetailsOfAcquisitionsAndDisposalsOfStocksEtcIssuedByIssuerOfSaidStocksEtcDuringLast60DaysIfCategorizedAsShortTermLargeVolumeTransferNATextBlock
	...
	def getFundingForAcquisitionOfStocksEtcHeldAbstract(self): #保有株券等の取得資金 [タイトル項目]
		return self.FundingForAcquisitionOfStocksEtcHeldAbstract

	def getBreakdownOfFundingAbstract(self): #取得資金の内訳 [タイトル項目]
		return self.BreakdownOfFundingAbstract

	def getAmountOfOwnFund(self): #自己資金額
		return self.AmountOfOwnFund

	def getTotalAmountOfBorrowings(self): #借入金額計
		return self.TotalAmountOfBorrowings

	def getTotalAmountFromOtherSources(self): #その他金額計
		return self.TotalAmountFromOtherSources

	def getBreakdownOfTotalAmountFromOtherSources(self): #上記（その他金額計）の内訳
		return self.BreakdownOfTotalAmountFromOtherSources

	def getTotalAmountOfFundingForAcquisition(self): #取得資金合計
		return self.TotalAmountOfFundingForAcquisition

	def getNotesFundingForAcquisitionOfStocksEtcHeldTextBlock(self): #欄外注記、取得資金の内訳 [テキストブロック]
		return self.NotesFundingForAcquisitionOfStocksEtcHeldTextBlock

	def getBreakdownOfBorrowingsAbstract(self): #借入金の内訳 [タイトル項目]
		return self.BreakdownOfBorrowingsAbstract

	def getBreakdownOfBorrowingsTextBlock(self): #借入金の内訳 [テキストブロック]
		return self.BreakdownOfBorrowingsTextBlock

	def getBreakdownOfBorrowingsNATextBlock(self): #借入金の内訳（該当なし） [テキストブロック]
		return self.BreakdownOfBorrowingsNATextBlock

	def getNamesEtcOfCreditorsAbstract(self): #借入先の名称等 [タイトル項目]
		return self.NamesEtcOfCreditorsAbstract

	def getNamesEtcOfCreditorsTextBlock(self): #借入先の名称等 [テキストブロック]
		return self.NamesEtcOfCreditorsTextBlock

	def getNamesEtcOfCreditorsNATextBlock(self): #借入先の名称等（該当なし） [テキストブロック]
		return self.NamesEtcOfCreditorsNATextBlock
