...
class jpcrp120200:#企業内容等の開示に関する内閣府令 第十二号の二様式 発行登録追補書類
	CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo122ShelfRegistrationSupplementsHeading = '' #企業内容等の開示に関する内閣府令 第十二号の二様式 発行登録追補書類 [目次項目]
	CoverPageHeading = '' #表紙 [目次項目]
	CoverPageHeading = '' #表紙 [目次項目]
	ShelfRegistrationSupplementNumberCoverPage = '' #発行登録追補書類番号、表紙
	...
	AmountOfOfferingOrDistributionByThisRegistrationCoverPageTextBlock = '' #今回の募集（売出）金額、表紙 [テキストブロック]
	ContentsOfShelfRegistrationStatementCoverPageAbstract = '' #発行登録書の内容、表紙 [タイトル項目]
	FilingDateContentsOfShelfRegistrationStatementCoverPage = '' #提出日、発行登録書の内容、表紙
	EffectiveDateContentsOfShelfRegistrationStatementCoverPage = '' #効力発生日、発行登録書の内容、表紙
	EndOfPeriodOfIssueContentsOfShelfRegistrationStatementCoverPage = '' #有効期限、発行登録書の内容、表紙
	ShelfRegistrationNumberContentsOfShelfRegistrationStatementCoverPage = '' #発行登録番号、発行登録書の内容、表紙
	PlannedAmountOfIssueOrLimitOnOutstandingBalanceContentsOfShelfRegistrationStatementCoverPage = '' #発行予定額又は発行残高の上限、発行登録書の内容、表紙
	RemainingAmountOrRemainingBalanceContentsOfShelfRegistrationStatementCoverPage = '' #残額又は残高、発行登録書の内容、表紙
	...
	InformationAboutTenderOfferHeading = '' #公開買付けに関する情報 [目次項目]
	InformationAboutTenderOfferTextBlock = '' #公開買付けに関する情報 [テキストブロック]
	OverviewOfTenderOfferHeading = '' #公開買付けの概要 [目次項目]
	OverviewOfTenderOfferTextBlock = '' #公開買付けの概要 [テキストブロック]
	PurposesEtcOfTenderOfferHeading = '' #公開買付けの目的等 [目次項目]
	PurposesEtcOfTenderOfferTextBlock = '' #公開買付けの目的等 [テキストブロック]
	OverviewOfPartyCarryingOutTenderOfferHeading = '' #公開買付けの当事会社の概要 [目次項目]
	OverviewOfPartyCarryingOutTenderOfferTextBlock = '' #公開買付けの当事会社の概要 [テキストブロック]
	ContractOfTenderOfferHeading = '' #公開買付けに係る契約 [目次項目]
	ContractOfTenderOfferTextBlock = '' #公開買付けに係る契約 [テキストブロック]
	ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferHeading = '' #公開買付けに係る割当ての内容及びその算定根拠 [目次項目]
	ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferTextBlock = '' #公開買付けに係る割当ての内容及びその算定根拠 [テキストブロック]
	DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferHeading = '' #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [目次項目]
	DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferTextBlock = '' #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [テキストブロック]
	...
	ProceduresRelatedToTenderOfferHeading = '' #公開買付けに関する手続 [目次項目]
	ProceduresRelatedToTenderOfferTextBlock = '' #公開買付けに関する手続 [テキストブロック]
	CombinedFinancialInformationHeading = '' #統合財務情報 [目次項目]
	CombinedFinancialInformationTextBlock = '' #統合財務情報 [テキストブロック]
	SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyHeading = '' #発行者（その関連者）と対象者との重要な契約 [目次項目]
	SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyTextBlock = '' #発行者（その関連者）と対象者との重要な契約 [テキストブロック]
	...
	def setInfo(self, edinet_info_list):
		for fact in self.model_xbrl.facts:
			if fact.concept.qname.localName == 'EDINETCodeDEI':
				...
				for code_name in edinet_info_list:
					if code_name[0] == self.edinet_code:
						...
						break
			elif fact.concept.qname.localName == 'CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo122ShelfRegistrationSupplementsHeading': #企業内容等の開示に関する内閣府令 第十二号の二様式 発行登録追補書類 [目次項目]
				self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo122ShelfRegistrationSupplementsHeading = fact.value
			...
			elif fact.concept.qname.localName == 'ShelfRegistrationSupplementNumberCoverPage': #発行登録追補書類番号、表紙
				self.ShelfRegistrationSupplementNumberCoverPage = fact.value
			...
			elif fact.concept.qname.localName == 'AmountOfOfferingOrDistributionByThisRegistrationCoverPageTextBlock': #今回の募集（売出）金額、表紙 [テキストブロック]
				self.AmountOfOfferingOrDistributionByThisRegistrationCoverPageTextBlock = fact.value

			elif fact.concept.qname.localName == 'ContentsOfShelfRegistrationStatementCoverPageAbstract': #発行登録書の内容、表紙 [タイトル項目]
				self.ContentsOfShelfRegistrationStatementCoverPageAbstract = fact.value

			elif fact.concept.qname.localName == 'FilingDateContentsOfShelfRegistrationStatementCoverPage': #提出日、発行登録書の内容、表紙
				self.FilingDateContentsOfShelfRegistrationStatementCoverPage = fact.value

			elif fact.concept.qname.localName == 'EffectiveDateContentsOfShelfRegistrationStatementCoverPage': #効力発生日、発行登録書の内容、表紙
				self.EffectiveDateContentsOfShelfRegistrationStatementCoverPage = fact.value

			elif fact.concept.qname.localName == 'EndOfPeriodOfIssueContentsOfShelfRegistrationStatementCoverPage': #有効期限、発行登録書の内容、表紙
				self.EndOfPeriodOfIssueContentsOfShelfRegistrationStatementCoverPage = fact.value

			elif fact.concept.qname.localName == 'ShelfRegistrationNumberContentsOfShelfRegistrationStatementCoverPage': #発行登録番号、発行登録書の内容、表紙
				self.ShelfRegistrationNumberContentsOfShelfRegistrationStatementCoverPage = fact.value

			elif fact.concept.qname.localName == 'PlannedAmountOfIssueOrLimitOnOutstandingBalanceContentsOfShelfRegistrationStatementCoverPage': #発行予定額又は発行残高の上限、発行登録書の内容、表紙
				self.PlannedAmountOfIssueOrLimitOnOutstandingBalanceContentsOfShelfRegistrationStatementCoverPage = fact.value

			elif fact.concept.qname.localName == 'RemainingAmountOrRemainingBalanceContentsOfShelfRegistrationStatementCoverPage': #残額又は残高、発行登録書の内容、表紙
				self.RemainingAmountOrRemainingBalanceContentsOfShelfRegistrationStatementCoverPage = fact.value
			...
			elif fact.concept.qname.localName == 'InformationAboutTenderOfferHeading': #公開買付けに関する情報 [目次項目]
				self.InformationAboutTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'InformationAboutTenderOfferTextBlock': #公開買付けに関する情報 [テキストブロック]
				self.InformationAboutTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'OverviewOfTenderOfferHeading': #公開買付けの概要 [目次項目]
				self.OverviewOfTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'OverviewOfTenderOfferTextBlock': #公開買付けの概要 [テキストブロック]
				self.OverviewOfTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'PurposesEtcOfTenderOfferHeading': #公開買付けの目的等 [目次項目]
				self.PurposesEtcOfTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'PurposesEtcOfTenderOfferTextBlock': #公開買付けの目的等 [テキストブロック]
				self.PurposesEtcOfTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'OverviewOfPartyCarryingOutTenderOfferHeading': #公開買付けの当事会社の概要 [目次項目]
				self.OverviewOfPartyCarryingOutTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'OverviewOfPartyCarryingOutTenderOfferTextBlock': #公開買付けの当事会社の概要 [テキストブロック]
				self.OverviewOfPartyCarryingOutTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'ContractOfTenderOfferHeading': #公開買付けに係る契約 [目次項目]
				self.ContractOfTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'ContractOfTenderOfferTextBlock': #公開買付けに係る契約 [テキストブロック]
				self.ContractOfTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferHeading': #公開買付けに係る割当ての内容及びその算定根拠 [目次項目]
				self.ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferTextBlock': #公開買付けに係る割当ての内容及びその算定根拠 [テキストブロック]
				self.ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferTextBlock = fact.value

			elif fact.concept.qname.localName == 'DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferHeading': #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [目次項目]
				self.DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferTextBlock': #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [テキストブロック]
				self.DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'ProceduresRelatedToTenderOfferHeading': #公開買付けに関する手続 [目次項目]
				self.ProceduresRelatedToTenderOfferHeading = fact.value

			elif fact.concept.qname.localName == 'ProceduresRelatedToTenderOfferTextBlock': #公開買付けに関する手続 [テキストブロック]
				self.ProceduresRelatedToTenderOfferTextBlock = fact.value
			...
			elif fact.concept.qname.localName == 'SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyHeading': #発行者（その関連者）と対象者との重要な契約 [目次項目]
				self.SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyHeading = fact.value

			elif fact.concept.qname.localName == 'SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyTextBlock': #発行者（その関連者）と対象者との重要な契約 [テキストブロック]
				self.SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyTextBlock = fact.value
	...
	def getCabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo122ShelfRegistrationSupplementsHeading(self): #企業内容等の開示に関する内閣府令 第十二号の二様式 発行登録追補書類 [目次項目]
		return self.CabinetOfficeOrdinanceOnDisclosureOfCorporateInformationEtcFormNo122ShelfRegistrationSupplementsHeading
	...
	def getShelfRegistrationSupplementNumberCoverPage(self): #発行登録追補書類番号、表紙
		return self.ShelfRegistrationSupplementNumberCoverPage
	...
	def getAmountOfOfferingOrDistributionByThisRegistrationCoverPageTextBlock(self): #今回の募集（売出）金額、表紙 [テキストブロック]
		return self.AmountOfOfferingOrDistributionByThisRegistrationCoverPageTextBlock

	def getContentsOfShelfRegistrationStatementCoverPageAbstract(self): #発行登録書の内容、表紙 [タイトル項目]
		return self.ContentsOfShelfRegistrationStatementCoverPageAbstract

	def getFilingDateContentsOfShelfRegistrationStatementCoverPage(self): #提出日、発行登録書の内容、表紙
		return self.FilingDateContentsOfShelfRegistrationStatementCoverPage

	def getEffectiveDateContentsOfShelfRegistrationStatementCoverPage(self): #効力発生日、発行登録書の内容、表紙
		return self.EffectiveDateContentsOfShelfRegistrationStatementCoverPage

	def getEndOfPeriodOfIssueContentsOfShelfRegistrationStatementCoverPage(self): #有効期限、発行登録書の内容、表紙
		return self.EndOfPeriodOfIssueContentsOfShelfRegistrationStatementCoverPage

	def getShelfRegistrationNumberContentsOfShelfRegistrationStatementCoverPage(self): #発行登録番号、発行登録書の内容、表紙
		return self.ShelfRegistrationNumberContentsOfShelfRegistrationStatementCoverPage

	def getPlannedAmountOfIssueOrLimitOnOutstandingBalanceContentsOfShelfRegistrationStatementCoverPage(self): #発行予定額又は発行残高の上限、発行登録書の内容、表紙
		return self.PlannedAmountOfIssueOrLimitOnOutstandingBalanceContentsOfShelfRegistrationStatementCoverPage

	def getRemainingAmountOrRemainingBalanceContentsOfShelfRegistrationStatementCoverPage(self): #残額又は残高、発行登録書の内容、表紙
		return self.RemainingAmountOrRemainingBalanceContentsOfShelfRegistrationStatementCoverPage
	...
	def getInformationAboutTenderOfferHeading(self): #公開買付けに関する情報 [目次項目]
		return self.InformationAboutTenderOfferHeading

	def getInformationAboutTenderOfferTextBlock(self): #公開買付けに関する情報 [テキストブロック]
		return self.InformationAboutTenderOfferTextBlock

	def getOverviewOfTenderOfferHeading(self): #公開買付けの概要 [目次項目]
		return self.OverviewOfTenderOfferHeading

	def getOverviewOfTenderOfferTextBlock(self): #公開買付けの概要 [テキストブロック]
		return self.OverviewOfTenderOfferTextBlock

	def getPurposesEtcOfTenderOfferHeading(self): #公開買付けの目的等 [目次項目]
		return self.PurposesEtcOfTenderOfferHeading

	def getPurposesEtcOfTenderOfferTextBlock(self): #公開買付けの目的等 [テキストブロック]
		return self.PurposesEtcOfTenderOfferTextBlock

	def getOverviewOfPartyCarryingOutTenderOfferHeading(self): #公開買付けの当事会社の概要 [目次項目]
		return self.OverviewOfPartyCarryingOutTenderOfferHeading

	def getOverviewOfPartyCarryingOutTenderOfferTextBlock(self): #公開買付けの当事会社の概要 [テキストブロック]
		return self.OverviewOfPartyCarryingOutTenderOfferTextBlock

	def getContractOfTenderOfferHeading(self): #公開買付けに係る契約 [目次項目]
		return self.ContractOfTenderOfferHeading

	def getContractOfTenderOfferTextBlock(self): #公開買付けに係る契約 [テキストブロック]
		return self.ContractOfTenderOfferTextBlock

	def getParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferHeading(self): #公開買付けに係る割当ての内容及びその算定根拠 [目次項目]
		return self.ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferHeading

	def getParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferTextBlock(self): #公開買付けに係る割当ての内容及びその算定根拠 [テキストブロック]
		return self.ParticularsOfAllotmentAndBasisForCalculationPertainingToTenderOfferTextBlock

	def getDifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferHeading(self): #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [目次項目]
		return self.DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferHeading

	def getDifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferTextBlock(self): #対象者の発行有価証券と公開買付けに係る提出会社によって発行（交付）される有価証券との相違 [テキストブロック]
		return self.DifferencesBetweenSecuritiesOfSubjectCompanyAndSecuritiesIssuedOrDeliveredByTenderOfferTextBlock
	...
	def getProceduresRelatedToTenderOfferHeading(self): #公開買付けに関する手続 [目次項目]
		return self.ProceduresRelatedToTenderOfferHeading

	def getProceduresRelatedToTenderOfferTextBlock(self): #公開買付けに関する手続 [テキストブロック]
		return self.ProceduresRelatedToTenderOfferTextBlock
	...
	def getSignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyHeading(self): #発行者（その関連者）と対象者との重要な契約 [目次項目]
		return self.SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyHeading

	def getSignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyTextBlock(self): #発行者（その関連者）と対象者との重要な契約 [テキストブロック]
		return self.SignificantContractsBetweenIssuerAndOrItsRelatedPartiesAndSubjectCompanyTextBlock
